        ...
        jQuery('#sb_instagram.sbi').each(function(){
            ...
            jQuery.each( looparray, function( index, entry ) {
                ...
                var userFeed = new instagramfeed({
                    ...
                    template: '<div class="sbi_item sbi_type_{{model.type}} sbi_new" id="sbi_{{id}}" data-date="{{model.created_time_raw}}"><div class="sbi_photo_wrap"><a class="sbi_photo" data-strip-group="instagram" href="{{image}}" target="_blank"><img src="{{image}}" alt="{{caption}}" width="200" height="200" /></a></div></div>',
