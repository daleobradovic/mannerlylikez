...
function sb_instagram_styles_enqueue() {
    ...
    wp_register_style( 'sb_strip_master_styles', plugins_url('/strip-master/css/strip.css', __FILE__), array(), SBIVER );
    wp_enqueue_style( 'sb_instagram_styles' );
    wp_enqueue_style( 'sb_strip_master_styles' );
...
function sb_instagram_scripts_enqueue() {
    ...
    wp_register_script( 'sb_strip_master_scripts', plugins_url( '/strip-master/js/strip.pkgd.js' , __FILE__ ), array('jquery'), SBIVER, true );
    wp_enqueue_script( 'sb_strip_master_scripts' );
